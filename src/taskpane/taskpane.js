console.log('taskpane.js loaded - Server PDF engine only v4.1.0');
    ...
    try {
        ...
        const requestData = {
            ...
            options: {
                ...
                footerTemplate: `
                    <div style="font-size: 10px; margin: 0 1cm; width: 100%; text-align: center;">
                        Generated by Email2PDF • Page <span class="pageNumber"></span> of <span class="totalPages"></span>
                    </div>
                `,
        ...
        const response = await fetch(`${serverUrl}/convert-email`, {
            method: 'POST',
            headers: {
